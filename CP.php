...
$patients=[];
$id=($_GET['id']);
$sql="SELECT nom,prenom,dateNais,taille,sexe,poids,age,nom_m,prenom_m,nomh,datec,mobileNumber,sId,idc,resume,maladie FROM consultation,Hopitaux,Medecin,Patients WHERE Patients.sId='$id' && Patients.sId=consultation.idp && Hopitaux.id=consultation.idh && Medecin.identifiant=consultation.idm";
